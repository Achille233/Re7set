    ...
    return (
        <section className="relative min-h-screen flex flex-col justify-center px-6 pt-32 pb-24 md:px-12 lg:px-24 bg-transparent w-full overflow-hidden">
            ...
            <div className="max-w-6xl w-full mx-auto flex flex-col items-center justify-center flex-grow text-center relative z-10">
                ...
                {/* Badge Pill */}
                <div className="flex items-center justify-center gap-4 px-5 py-2.5 rounded-full border border-foreground/10 bg-white/60 backdrop-blur-md mb-8 shadow-sm">
                    ...
                    <span className="text-xs uppercase tracking-widest font-mono text-foreground/80 font-medium">
                        Systèmes IA & Visibilité Structurée
                    </span>
                ...
                <h1
                    ref={titleRef}
                    className="text-4xl md:text-6xl lg:text-7xl font-serif text-foreground leading-[1.1] tracking-tight mb-8 max-w-5xl mx-auto"
                >
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-base font-sans text-muted mb-12 max-w-2xl mx-auto">
                        Nous intégrons l'IA au cœur de votre cabinet et structurons votre image de marque pour décupler votre efficacité et votre croissance.
                    </p>
                </div>
