...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-[100dvh] flex flex-col justify-center px-6 pt-32 pb-16 md:px-12 lg:px-24 bg-transparent w-full overflow-hidden">
            ...
            <div className="max-w-6xl w-full mx-auto flex flex-col items-center justify-center flex-grow text-center relative z-10 mt-8 md:mt-16">
                ...
                <div className="flex flex-col items-center mb-24 cursor-pointer w-full">
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-4">
                        <a href={SITE_CONFIG.calendlyUrl} target="_blank" rel="noopener noreferrer" className="group relative px-8 py-4 bg-primary text-white flex items-center justify-center gap-2 rounded hover:brightness-110 transition-all duration-300 shadow-[0_0_30px_-5px_rgba(37,99,235,0.3)] hover:shadow-[0_0_40px_-5px_rgba(37,99,235,0.5)]">
                            <span className="font-medium text-lg">Réserver mon audit gratuit</span>
