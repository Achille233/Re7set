...
export function TestimonialsSection({
    ...
    return (
        <section className={cn(
            ...
            "py-20 px-0 overflow-hidden relative",
            className
        )}>
            <div className="mx-auto flex w-full flex-col items-center gap-4 text-center sm:gap-16 relative z-10">
                <div className="flex flex-col items-center gap-4 px-4 sm:gap-8 mb-8 max-w-container">
                    <h2 className="max-w-[720px] text-4xl md:text-5xl lg:text-6xl font-sans font-medium leading-tight tracking-tight text-foreground">
                        {title}
                    </h2>
